...
const baseURL = "https://apiv2.napolyon.com";
...
axios.interceptors.response.use(
  ...
  (error) => {
    ...
    if (
      ...
      originalRequest.url == baseURL + "/mobile/login/token"
    ) {
    ...
    if (error.message === "Network Error") {
      ...
      if (refreshToken) {
        ...
        return axios
          .post(baseURL + "/mobile/login/token", credentials, tmpHeaders)
          .then((response) => {

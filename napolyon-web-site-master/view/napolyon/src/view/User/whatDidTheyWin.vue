              ...
              <div class="main-timeline5">
                <div class="timeline" data-order="1" data-dg="slideInRight">
                  ...
                  <div class="timeline-content">
                    <img src="http://cdn.napolyon.com/napolyon/kampanya/750x330/flormar-2015.jpg" alt="">
                ...
                <div class="timeline" data-order="2" data-dg="slideInLeft">
                  <div class="timeline-icon"><span class="year"><img :src="mediaBase + '/images/nap.png'" alt=""></span></div>
                  <div class="timeline-content">
                    <img src="http://cdn.napolyon.com/napolyon/kampanya/750x330/eglencenin-adresi.jpg" alt="">
                    <div class="timeline-body">
                ...
                <div class="timeline" data-order="3" data-dg="slideInRight">
                  <div class="timeline-icon"><span class="year"><img :src="mediaBase + '/images/nap.png'" alt=""></span></div>
                  <div class="timeline-content">
                    <img src="http://cdn.napolyon.com/napolyon/kampanya/750x330/nap-puan-yagmuru.jpg" alt="">
                    <div class="timeline-body">
                ...
                <div class="timeline" data-order="4" data-dg="slideInLeft">
                  <div class="timeline-icon"><span class="year"><img :src="mediaBase + '/images/nap.png'" alt=""></span></div>
                  <div class="timeline-content">
                    <img src="http://cdn.napolyon.com/napolyon/kampanya/750x330/zamanakarsi.jpg" alt="">
                    <div class="timeline-body">
                ...
                <div class="timeline" data-order="5" data-dg="slideInRight">
                  <div class="timeline-icon"><span class="year"><img :src="mediaBase + '/images/nap.png'" alt=""></span></div>
                  <div class="timeline-content">
                    <img src="http://cdn.napolyon.com/napolyon/kampanya/750x330/rifat-yuzuak-2015.jpg" alt="">
                    <div class="timeline-body">

          ...
          <div class="col-lg-4 cover-my-30 order-2 background-napolyon2">
            <div class="cover-user-img d-flex align-items-center">
              <div class="row">
                <div class="col-12">
                  <div
                    class="card login-page border-0"
                      ...
                      <form class="login-form mt-4">
                        <div class="row">
                          ...
                          <template v-if="!key">
                            <div class="col-lg-12 text-center">
                              <div class="d-block">
                                Üyeliğinizi başlatmak için hemen e-posta
                                adresinize gönderilen bağlantıya tıklayın,
                                profil bilgilerinizi tamamladıktan sonra anket,
                                yarışma ve gizli görevlere katılarak kazanmaya
                                başlayın.

                                <br />
                                <br />
                                Eğer gelen e-posta, “Gereksiz Kutunuza” düşmüşse
                                lütfen Napolyon.com’dan gelen e-postanızı
                                “Güvenli Mail” olarak işaretlemeyi unutmayın!
                                Konuyla ilgili
                                <a
                                  href="https://www.napolyon.com/#/bize-ulasin?form"
                                  >"Bize Ulaşın"</a
...
export default {
  data() {
    return {
      ...
      success: null,
      action:
        "<div class='d-block alert alert-info'>İşlem yapılıyor. Lütfen bekleyiniz</div>",
    };
  },
  computed: {
    isMobile() {
